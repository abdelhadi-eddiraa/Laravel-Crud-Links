<x-app-layout>
    <div class="mx-auto max-w-screen-lg px-4 py-8 sm:px-8  ">
        ...
        <form class=""  action="{{route('links.store')}}" method="POST">
            ...
            <div class="p-56  ">
                ...
                <div class="flex max-h-screen flex-col space-y-5 rounded-lg border py-10 px-5 shadow-xl mx-auto">
                    ...
                    <div class="mx-auto mb-2 space-y-3">
                       <h1 class=" text-8xl font-bold text-gray-700">Create Links</h1>
                  ...
                  <div class="py-3">
                    <div class="relative mt-2 w-full">
                      ...
                      <input type="text" name="name" value="{{old('name')}}" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    </div>
                  ...
                  <div  class="py-3">
                    <div class="relative mt-2 w-full">
                      ...
                      <input type="text" name="link" value="{{old('link')}}" class="border-1 peer block w-full appearance-none rounded-lg border border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0" placeholder=" " />
                    </div>
